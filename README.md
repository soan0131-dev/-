...
- **전직원 현황판** (`/employees`): 기본 인적사항, 본/지사·부서, 재직상태, 연락처, 직급/자격,
  ...
  지원해 사용자가 다운로드한 파일에서 자유롭게 추가 필터링·피벗할 수 있습니다.
- **입퇴사 케이스 생성** (`/cases/new`, HR/관리자 전용): 입사자는 본/지사·부서(종속 드롭다운),
  직급(선택 시 파트너 유형 조건부 노출), 자격(중복 선택) 등 신규 직원 정보를 입력해 케이스를
  시작합니다. 퇴사자는 이름/사번으로 검색해 전직원 중에서 선택하고, 퇴사 사유를
  개인사유/이직/권고사직/기타 중 선택(기타 선택 시 직접 입력)해 케이스를 시작합니다.
